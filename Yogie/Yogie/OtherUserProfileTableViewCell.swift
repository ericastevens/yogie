...
class OtherUserProfileTableViewCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        postImageView.image = #imageLiteral(resourceName: "Yoga Movement Beyonce Knowles")
    ...
    func setupViewHierarchy() {
        ...
        postImageView.addSubview(timestampLabel)
    ...
    func configureConstraints() {
        let _ = [
            ...
            postImageView.bottomAnchor.constraint(equalTo: engagementButtonsContainerView.topAnchor),
            ...
            postImageView.heightAnchor.constraint(equalToConstant: 375),
            
            timestampLabel.widthAnchor.constraint(equalToConstant: 45),
            timestampLabel.heightAnchor.constraint(equalToConstant: 32),
            timestampLabel.topAnchor.constraint(equalTo: postImageView.topAnchor, constant: 12.0),
            timestampLabel.trailingAnchor.constraint(equalTo: postImageView.trailingAnchor, constant: -12.0),
